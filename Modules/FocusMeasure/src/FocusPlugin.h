...
class FocusInfo : public nmc::DkBatchInfo {

public:
	FocusInfo(const QString& id = QString(), const QString& filePath = QString());
...
class FocusPlugin : public QObject, nmc::DkBatchPluginInterface {
	Q_OBJECT
		Q_INTERFACES(nmc::DkBatchPluginInterface)
		Q_PLUGIN_METADATA(IID "com.nomacs.ImageLounge.FocusPlugin/3.1" FILE "FocusPlugin.json")
