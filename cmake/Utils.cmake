...
macro(RDM_GENERATE_PACKAGE_XML)
	...
	string(REPLACE "," ";" lines ${JSON_CONTENT} )
	foreach(line ${lines})
		string(REGEX MATCHALL ".*\"PluginName\".*:" matches ${line})
		if(matches)
		...
		string(REGEX MATCHALL ".*\"AuthorName\".*:" matches ${line})
		if(matches)
		...
		string(REGEX MATCHALL ".*\"Company\".*:" matches ${line})
		if(matches)
		...
		string(REGEX MATCHALL ".*\"Description\".*:" matches ${line})
		if(matches)
		...
		string(REGEX MATCHALL ".*\"DateModified\".*:" matches ${line})
		if(matches)
